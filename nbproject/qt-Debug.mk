...
# Generated by qmake (2.01a) (Qt 4.4.3) on: mar dic 15 18:13:11 2009
...
SOURCES       = source/MenuCreaLivello.cpp \
		...
		source/MenuInserisciParola.cpp \
		main.cpp \
		source/Livello.cpp \
		source/MenuAppoggio.cpp \
		source/Gioco.cpp \
...
OBJECTS       = build/Debug/GNU-Linux-x86/MenuCreaLivello.o \
		...
		build/Debug/GNU-Linux-x86/MenuInserisciParola.o \
		build/Debug/GNU-Linux-x86/main.o \
		build/Debug/GNU-Linux-x86/Livello.o \
		build/Debug/GNU-Linux-x86/MenuAppoggio.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0/ && $(COPY_FILE) --parents include/MenuInserisciParola.h include/Textures.h include/pezzi/Pezzo.h include/PosTelecamere.h include/MenuCentrale.h include/MenuLaterale.h include/Interfaccia.h include/Elemento.h include/basi/Base.h include/MenuAttivo.h include/Presentazione.h include/Telecamera.h include/MenuCreaLivello.h include/GestoreGiocatori.h include/TelecameraProspettica.h include/Editor.h include/Menu.h include/Domino.h include/Partita.h include/Giocatore.h include/ElementoAttivo.h include/Griglia.h include/TelecameraAssionometrica.h include/GestoreLivelli.h include/Livello.h include/Gioco.h nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0/ && $(COPY_FILE) --parents source/MenuCreaLivello.cpp source/GestoreLivelli.cpp source/Editor.cpp source/PosTelecamere.cpp source/basi/Base.cpp source/Elemento.cpp source/Griglia.cpp source/Menu.cpp source/Textures.cpp source/Telecamera.cpp source/TelecameraProspettica.cpp source/MenuLaterale.cpp source/ElementoAttivo.cpp source/Interfaccia.cpp source/TelecameraAssionometrica.cpp source/GestoreGiocatori.cpp source/MenuInserisciParola.cpp main.cpp source/Livello.cpp source/MenuAppoggio.cpp source/Gioco.cpp source/MenuCentrale.cpp source/MenuAttivo.cpp source/Partita.cpp source/Giocatore.cpp source/Presentazione.cpp source/pezzi/Pezzo.cpp nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0` && $(TAR) OpenDomino1.0.0.tar OpenDomino1.0.0 && $(COMPRESS) OpenDomino1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0`/OpenDomino1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/OpenDomino1.0.0
...
build/Debug/GNU-Linux-x86/MenuCreaLivello.o: source/MenuCreaLivello.cpp include/Domino.h \
		include/Textures.h \
		include/Elemento.h \
		...
		include/Menu.h \
		include/Gioco.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MenuCreaLivello.o source/MenuCreaLivello.cpp
...
build/Debug/GNU-Linux-x86/MenuInserisciParola.o: source/MenuInserisciParola.cpp include/Domino.h \
		include/Textures.h \
		include/Elemento.h \
		include/ElementoAttivo.h \
		include/basi/Base.h \
		...
		include/Menu.h \
		include/Gioco.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MenuInserisciParola.o source/MenuInserisciParola.cpp
...
build/Debug/GNU-Linux-x86/MenuAppoggio.o: source/MenuAppoggio.cpp include/Domino.h \
		include/Textures.h \
		include/Elemento.h \
		include/ElementoAttivo.h \
		include/basi/Base.h \
		...
		include/Menu.h \
		include/Gioco.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MenuAppoggio.o source/MenuAppoggio.cpp
